...
import com.angus.expands.mybatis.plugins.PaginationResultSetInterceptor;
import com.angus.expands.mybatis.plugins.PaginationStatementInterceptor;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.angus.dao.mapper", sqlSessionFactoryRef = "sqlSessionFactory", sqlSessionTemplateRef = "sqlSessionTemplate")
...
public class DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder, DataSource dataSource) {
        ...
        entityManagerFactory.setPackagesToScan("com.angus.entity");
